...
struct ManifestData {
    ...
    std::string companion_payload_role;
    std::string companion_payload_file;
    std::string companion_payload_format;
    std::vector<std::string> continuation_policy_variants;
    std::vector<std::string> scope_variants;
    int gambit_horizon_plies = 0;
    std::string significance_method;
    double significance_z = 0.0;
    double gambit_t_sigma = 0.0;
    double gambit_delta_max = 0.0;
    int gambit_n_min = 0;
    int risky_candidate_support_floor = 0;
    std::string pooled_band_behavior;
    bool downward_propagation_applied = false;
    std::string family_mapping_source;
    bool family_annotation_optional = true;
    bool full_external_opening_book_used = false;
    std::string retained_opening_scope_mode;
    std::string ordinary_acceptance_oracle_provenance;
    std::string gambit_eligibility_policy;
    int gambit_companion_ordinary_rows = 0;
